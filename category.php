...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container">
            <h3 class="text-center">Thể loại: <?php echo $current_cate['name_category'] ?></h3>
            <div class="d-flex justify-content-center">
            <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php if($page - 1 == 0):?>
                            <li class="page-item disabled"><a class="page-link" href="category.php?category_id=<?php echo $category_id?>&minprice=<?php echo $minprice?>&maxprice=<?php echo $maxprice ?>&page=<?php echo $page -1?>">Previous</a></li>
                        <?php else:?>
                            <li class="page-item"><a class="page-link" href="category.php?category_id=<?php echo $category_id?>&minprice=<?php echo $minprice?>&maxprice=<?php echo $maxprice ?>&page=<?php echo $page -1?>">Previous</a></li>
                        <?php endif;?>
                        ...
                        <?php if($page +1 > $number_page):?>
                            <li class="page-item disabled"><a class="page-link" href="category.php?category_id=<?php echo $category_id?>&minprice=<?php echo $minprice?>&maxprice=<?php echo $maxprice ?>&page=<?php echo $page +1?>">Next</a></li>
                        <?php else:?>
                            <li class="page-item"><a class="page-link" href="category.php?category_id=<?php echo $category_id?>&minprice=<?php echo $minprice?>&maxprice=<?php echo $maxprice ?>&page=<?php echo $page +1?>">Next</a></li>
                        <?php endif;?>
                    </ul>
                </nav>
            </div>
